...
namespace NetworkCommsDotNet.Tools
{
    ...
    /// </summary>
    public class LiteLoggerDebug : ILogger
    {
        /// <summary>
        ...
        public LiteLoggerDebug(LogMode logMode)
        {
        ...
        public LiteLoggerDebug(LogMode logMode, string logFileLocationName)
        {
            _currentLogMode = logMode;
        ...
        {
            if (level == "Trace")
                return; // disable trace logging, uh
